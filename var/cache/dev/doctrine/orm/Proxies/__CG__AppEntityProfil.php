...
class Profil extends \App\Entity\Profil implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Profil' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Profil' . "\0" . 'libelle', '' . "\0" . 'App\\Entity\\Profil' . "\0" . 'archive', '' . "\0" . 'App\\Entity\\Profil' . "\0" . 'users'];
        }
     ...
     * {@inheritDoc}
     */
    public function setArchive(int $archive): \App\Entity\Profil
    {
