...
class getSecurity_Firewall_Map_Context_ApiService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 4), ($container->privates['security.exception_listener.api'] ?? $container->load('getSecurity_ExceptionListener_ApiService')), NULL, ($container->privates['security.firewall.map.config.api'] ?? $container->load('getSecurity_Firewall_Map_Config_ApiService')));
    }
}
